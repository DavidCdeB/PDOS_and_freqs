...
for indx_vols, indx_files in zip(range(1, len(vols)+1), range(len(vols))):
        ...
        ax.plot(x_222, y_222, color='lightskyblue', label='SCELPHONO 3 times Landau supercell') # black lines OK
        ax.grid()
...
for indx_vols, indx_files in zip(range(1, len(vols)+1), range(len(vols))):
        ...
        ax2 = ax.twinx()
        lns2 = ax2.plot(nu_SCEL_222, S_SCEL_222, 'lightskyblue', linestyle='--', label='Entropy')
...
#           alpha=1.0,
        ...
        ax2 = ax.twinx()
        ax2.plot(nu_SCEL_222, S_SCEL_222, 'lightskyblue', linestyle='--', label='Entropy SCELPHONO 2x2x2')
